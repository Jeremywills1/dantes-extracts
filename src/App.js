...
// Removed import "./App.css"; unless you actually have the file
    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 px-8 py-16 bg-neutral-900">
        {products.map((p) => (
          <div
            key={p.name}
            className="bg-black rounded-xl shadow-lg overflow-hidden hover:shadow-yellow-400/50 transition flex flex-col items-center text-center"
          >
            {/* 
              - aspect-[2/3] sets a 2:3 container shape 
              - object-contain shows the full image 
              - If your actual images have a different ratio, adjust 'aspect-[2/3]'
            */}
            <img
              src={p.img}
              alt={p.name}
              className="w-full aspect-[2/3] object-contain bg-black"
            />
            <div className="p-4">
