...
// NO import "./App.css"; unless you actually have it
...
function App() {
  ...
  return (
    <div style={{ 
      transform: "scale(1.75)",        // or whatever zoom you love
      ...
      <div className="min-h-screen bg-black text-white font-sans">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 px-8 py-16 bg-neutral-900">
          {products.map((p) => (
            <div 
              key={p.name} 
              className="bg-black rounded-xl shadow-lg overflow-hidden hover:shadow-yellow-400/50 transition"
            >
              <img 
                src={p.img} 
                alt={p.name} 
        ...
        <section className="px-8 py-20 text-center bg-black">
          ...
          <p className="max-w-3xl mx-auto text-lg text-gray-400">
            ...
            after the rabbit who never left our side. We carry that same 
            energy into every product — loyalty to quality, no shortcuts, 
            no compromise.
          </p>
        </section>
