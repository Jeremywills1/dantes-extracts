...
function App() {
  const products = [
    { name: "Vapes", img: "https://via.placeholder.com/400x250?text=Vapes" },
    { name: "Gummies", img: "https://via.placeholder.com/400x250?text=Gummies" },
    { name: "Disposables", img: "https://via.placeholder.com/400x250?text=Disposables" },
  ];
